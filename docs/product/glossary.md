...
| **Year** (Schedule view · both shells) | The Schedule's furthest-out lens: twelve month grids of day numerals — a **map of the year**, today marked with the signal ring, a tap to drill into a day (desk) or a month (phone). Load shading lived here and was cut (D-128): it competed with the dates and answered a question the chat's `read_calendar_load` already owns. Desktop `Y` / ⌘K; on the phone it is the **Y** rung of the horizon ladder. D-127, D-128. |
