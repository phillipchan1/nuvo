...
| **Show me around · Walk me through it** | The two doors on the first-run welcome. **Show me around** = the visual tour (rebuilt art, ~2 min, nothing to set up). **Walk me through it** = the live walkthrough — a panel docks beside the real app, names one act per step, lights the real element, and ticks from real data. Not a difference in content, a difference in *how you want to learn it*; either is skippable at every step and Back reopens the fork. D-059, [`orientation.md`](../orientation.md). |
