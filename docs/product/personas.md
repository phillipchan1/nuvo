...
| D6 | I just thought of something — where does it go so I stop holding it? | capture (⌘K / ⌥Space / ＋ / voice) | ✅ *2026-09-25 (D-149): ⌘K / ⌥Space / the phone's ＋ are one door making a task, event or slot; Enter always adds what you typed (search no longer steals it) and a failed add stays on screen. 2026-09-17 (D-146): every add box keeps what you typed.* |
...
| W2 | If I only get three real hours, where do they go? | Priorities + Sunday pull · **the Week's Plan's placed-vs-loose line** | ◐ *re-scored 2026-07-30 (D-060): each project now says how much of what's left has a time and how much is loose, which is the raw material for the answer — but nothing **ranks** them, so it stays ◐. **Reached the phone 2026-08-16 (D-110)**: it had been a desk-only answer — the phone's Calendar showed a month and never the week's slate — and both shells now wear the same read (`useWeekCrown`), so the split reads identically on either. **2026-08-27 (D-119):** the crown stays on the week-scoped lenses (List · Day · Week) and comes off Month, whose leftover space is the selected day's plan. Holds at ◐ for the original reason: still nothing ranks them.* |
