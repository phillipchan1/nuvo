...
| D6 | I just thought of something — where does it go so I stop holding it? | capture (⌘K / ⌥Space / voice) | ✅ *2026-09-17 (D-146): every add box now keeps what you typed — before, most kept only the title and a length and dropped the rest.* |
