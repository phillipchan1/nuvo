...
function CalendarPane({
  ...
  // every block (`RESET_RAW_EVENTS`) — KeepAlive measured that as a full
  // second on a lived-in week, which is the "drag it and it vanishes" hitch.
  // Freeze the prop we pass; mutate in place below.
