  ...
  return (
    <div>
      ...
      <button
        ...
        disabled={busy}
        onClick={go}
        className="tap fast mt-3 w-full rounded-md border border-accent bg-accent px-4 py-3 text-body font-medium text-white shadow-sm hover:brightness-110 active:translate-y-px disabled:opacity-50"
      >
