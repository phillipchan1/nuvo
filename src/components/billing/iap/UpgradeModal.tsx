...
export function IapUpgradeModal({ onClose }: { onClose: () => void }) {
    ...
    <Modal onClose={onClose} width="max-w-md">
      <div className="p-6 sm:p-7">
        ...
        <p className="mt-2 mb-5 text-caption leading-relaxed text-muted">
          {trialing && days > 0
            ? `You have ${days} day${days === 1 ? "" : "s"} left on your trial. Subscribe and nothing changes — your work, calendars, and plans stay exactly as they are.`
            : "Subscribe and nothing changes — your work, calendars, and plans stay exactly as they are."}
        </p>
        <IapChooser />
      </div>
    </Modal>
