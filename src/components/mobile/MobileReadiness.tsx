...
// funnel's "now what" rides the top of the Tasks → Week segment: one glass
// banner that surfaces the single most valuable next turn across the week and
// the vertical.
//
// It stays focused on what the phone otherwise can't see — is the week composed,
