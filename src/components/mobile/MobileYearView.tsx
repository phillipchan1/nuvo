...
export default function MobileYearView({
  ...
  return (
    <div>
      {/* The year's own numeral is the chrome's hero — said once (D-123 /
          D-129). The back door is the horizon ladder; this body draws
          neither. No legend: density is gone (D-128). */}
